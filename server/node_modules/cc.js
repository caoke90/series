...
cc.Snode=cc.Node.extend({
    ...
    _getQuery:function(data){
        var builder = require('mongo-sql');
        var result = builder.sql(data);
    ...
    onEnter:function(){
        ...
        return function(callback){
            the.connection.connect(callback);
        }
    },
    //结束
    onExit:function(){
    ...
    query:function(data){
        var the=this
        return function(callback){
            var query=typeof data=="string"?data:the._getQuery(data)
            cc.log(query)
            the.connection.query(query,function(err,data){
                callback(err,data)
            })
        }
    }
})
cc.Database=cc.Node.extend({
})
//context 包含html文本和事件
